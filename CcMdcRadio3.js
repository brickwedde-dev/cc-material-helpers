class CcMdcRadio3 extends HTMLElement {
  constructor() {
    super();
  ...
  connectedCallback() {
    ...
    this._disabled = this._disabled || this.getAttribute("disabled") === "true";
...
window.customElements.define("cc-mdc-radio3", CcMdcRadio3);
